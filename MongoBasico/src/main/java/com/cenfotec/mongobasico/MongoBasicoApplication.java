...
public class MongoBasicoApplication {
	...
	service.saveJournal(new Journal("Spring Boot Reading","Read moreabout Spring Boot","02/02/2016"));
	service.saveJournal(new Journal("Spring Boot in theCloud","Spring Boot using Cloud Foundry","03/01/2016"));
